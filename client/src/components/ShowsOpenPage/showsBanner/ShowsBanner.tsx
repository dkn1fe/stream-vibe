...
export const ShowsBanner = () => {
  const { showsInfo, showsInfoStatus } = useSelector(
    ...
    <>
      ...
      )}
      {
        <div
          style={{
            backgroundImage: `url(${
              showsInfo.coverUrl || showsInfo.posterUrlPreview
            })`,
          }}
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center pt-[280px] absolute inset-0 text-center z-10">
            <h3 className="text-5xl font-extrabold tracking-tight text-white">
              {showsInfo.nameOriginal || showsInfo.nameRu || showsInfo.nameEn}
            </h3>
